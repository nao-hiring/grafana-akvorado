...
export const parser = LRParser.deserialize({
  version: 14,
  states:
    "#xO]QPOOOhQQO'#CrO]QPO'#CoO]QPO'#CoOmQSO'#CoQOQPOOO{QWO,59^OOQO,59Z,59ZO!WQPO,59ZO]QPO,59ZOOQO'#Ce'#CeO!]QWO'#CeOOQO1G.x1G.xO!eQSO1G.uOOQO1G.u1G.uO!sQQO,59POOQO'#Ci'#CiO]QPO7+$aO!{QWO,59TOOQO1G.k1G.kOOQO<<G{<<G{OOQO1G.o1G.o",
  stateData:
    '#Z~ObOSPOSQOS~OSQOVPOdRO~OWUO~OTXOUXO`cXecX~OYYOZYO[ZO~Oe]O~OY`OZ`O~OTaOUaO`cieci~O^bO_cO~OYeOZeO~OSVZQZ~',
  goto: '!UgPPPPPPPPPhPPPkPPPPPnPP}R[UR_ZQTOQVQQWRQ^XRdaZSOQRXa',
  nodeNames:
    '⚠ LineComment BlockComment Filter Not And Or Column Operator Value String Literal ValueLParen ListOfValues ValueComma ValueRParen',
  maxTerm: 22,
  skippedNodes: [0, 1, 2],
  repeatNodeCount: 0,
  tokenData:
